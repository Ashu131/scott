      ...
      <div class="card-body">
        <form method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="exampleInputPassword1" type="password" placeholder="Password" name="pwd" required="required">
          </div>
          <!-- <div class="form-group">
