...
<html>
	<head>
		<title>Scott Conner - Human Capital Solutions|Professional</title>
		<!--/tags -->
					...
					<div class="col-md-8 job_info_left">
						<div class="tab_grid_prof">
							<div class="col-sm-3 loc_1">
								<a href="single.php"><img src="images/pf1.jpg" alt=""></a>
							</div>
							<div class="col-sm-9">
								<div class="location_box1">
									...
									<div class="read"><a href="single.php" class="read-more"> More Info</a></div>
									<ul class="top-btns">
						...
						<div class="tab_grid_prof">
							<div class="col-sm-3 loc_1">
								<a href="single.php"><img src="images/pf2.jpg" alt=""></a>
							</div>
							<div class="col-sm-9">
								<div class="location_box1">
									<h6>Francisco Da Silva</h6>
						...
						<div class="tab_grid_prof">
							<div class="col-sm-3 loc_1">
								<a href="single.php"><img src="images/pf3.jpg" alt=""></a>
							</div>
							<div class="col-sm-9">
								<div class="location_box1">
									<h6>Francisco Da Silva</h6>
						...
						<div class="tab_grid_prof">
							<div class="col-sm-3 loc_1">
								<a href="single.php"><img src="images/pf4.jpg" alt=""></a>
							</div>
							<div class="col-sm-9">
								<div class="location_box1">
									<h6>Francisco Da Silva</h6>
